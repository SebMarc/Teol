 ...
 */
final class Version20191130164852 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_96282C4CA76ED395 ON technicien');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_96282C4CA76ED395 ON technicien (user_id)');
    }
}
